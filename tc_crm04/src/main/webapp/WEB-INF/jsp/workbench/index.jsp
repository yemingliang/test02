    ...
    <script type="text/javascript">
        ...
        jQuery(function ($) {
            ...
            $("#changePwdBtn").click(function () {
                var realOldPwd = "${loginUser.loginPwd}";
                // 用户输入的旧密码，不一定正确！
                var userInputOldPwd = $("#oldPwd").val();
                ...
                userInputOldPwd = $.md5(userInputOldPwd);
                if(realOldPwd != userInputOldPwd) {
                    alert("原密码不正确！");
                    return ;
                }
